...
import 'package:flutter_plugins_with_net/http/request/api_get_request.dart';
import 'package:flutter_plugins_with_net/util/defend_error.dart';

import 'http/core/net_error.dart';
import 'http/request/api_post_request.dart';

void main() {
  DefendError().runAppPage(const MyApp());
